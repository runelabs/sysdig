...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_PAGE_FAULT_USER_E */ {"page_fault_user", EC_OTHER, EF_SKIPPARSERESET | EF_DROP_FALCO, 3, {{"addr", PT_UINT64, PF_HEX}, {"ip", PT_UINT64, PF_HEX}, {"error", PT_UINT64, PF_HEX} } },
	/* PPME_PAGE_FAULT_USER_X */ {"NA5", EC_OTHER, EF_UNUSED, 0},
	/* PPME_PAGE_FAULT_KERNEL_E */ {"page_fault_kernel", EC_OTHER, EF_SKIPPARSERESET | EF_DROP_FALCO, 3, {{"addr", PT_UINT64, PF_HEX}, {"ip", PT_UINT64, PF_HEX}, {"error", PT_UINT64, PF_HEX} } },
	/* PPME_PAGE_FAULT_KERNEL_X */ {"NA6", EC_OTHER, EF_UNUSED, 0},
};
